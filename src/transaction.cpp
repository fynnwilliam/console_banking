...
void transaction::log(activity &&a) noexcept { logs_.insert({++id_, a}); }
...
bool transaction::empty() const noexcept { return logs_.empty(); }
...
transaction::t_itr transaction::begin() noexcept { return logs_.begin(); }

transaction::t_citr transaction::begin() const noexcept {
  return logs_.cbegin();
}

transaction::t_itr transaction::end() noexcept { return logs_.end(); }

transaction::t_citr transaction::end() const noexcept { return logs_.cend(); }
