...
std::uint64_t id_generator::operator++() noexcept { return ++id_; }

std::uint64_t id_generator::operator++(int) noexcept { return id_++; }

id_generator::~id_generator() { save_last_id(); }